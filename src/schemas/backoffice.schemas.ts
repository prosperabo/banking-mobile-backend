...
export interface BackofficeRefreshRequest {
  customer_refresh_token: string;
  device_id: string;
  ecommerce_token: string;
  extra_login_data: string;
...
export interface BackofficeRefreshResponse {
  response: {
    oauth_token: string;
    expiration_timestamp: string;
  };
...
export interface BackofficeCreateUserResponse {
  rs: BackofficeUser;
  err: string | null;
}
